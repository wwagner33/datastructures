...
******************************************************************************************
	...
	@description Programa que implementa a Questão 03 da lista de exercícios EDA_List1.pdf
...
func lst_retira(lista *Lista, val int) *Lista {
	var p *Lista = lst_busca(lista, val)
	// verifica se achou elemento
	if p == nil {
		return lista /* não achou */
	}
	if lista == p { /* se é o primeiro elemento */
		lista = p.proximo
